...
class OpenAIServingCompletion(OpenAIServingBase):
    ...
    def _build_sampling_params(self, request: CompletionRequest) -> Dict[str, Any]:
        ...
        sampling_params = {
            ...
            "loop_ngram_size": request.loop_ngram_size,
            "loop_window_size": request.loop_window_size,
            "loop_penalty": request.loop_penalty,
            "loop_repeat_threshold": request.loop_repeat_threshold,
            "loop_min_output_tokens": request.loop_min_output_tokens,
            "loop_hard_block": request.loop_hard_block,
            "loop_observe_only": request.loop_observe_only,
            "loop_debug": request.loop_debug,
            "regex": request.regex,

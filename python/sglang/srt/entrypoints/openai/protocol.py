...
class ChatCompletionRequest(BaseModel):
    ...
    loop_ngram_size: Optional[int] = None
    loop_window_size: Optional[int] = None
    loop_penalty: Optional[float] = None
    loop_repeat_threshold: Optional[int] = None
    loop_min_output_tokens: Optional[int] = None
    loop_hard_block: Optional[bool] = None
    loop_observe_only: Optional[bool] = None
    ...
    def to_sampling_params(
        ...
        sampling_params = {
            ...
            "loop_ngram_size": self.loop_ngram_size,
            "loop_window_size": self.loop_window_size,
            "loop_penalty": self.loop_penalty,
            "loop_repeat_threshold": self.loop_repeat_threshold,
            "loop_min_output_tokens": self.loop_min_output_tokens,
            "loop_hard_block": self.loop_hard_block,
            "loop_observe_only": self.loop_observe_only,
            "loop_debug": self.loop_debug,
            "regex": self.regex,
            "ebnf": self.ebnf,
            "n": self.n,

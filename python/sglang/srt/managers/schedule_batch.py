...
class Req(ReqDllmMixin):
    ...
    def init_next_round_input(
        ...
        # In PP prefill with HiCache, all PP stages must skip the same number of
        # prefix tokens, otherwise per-stage out_cache_loc lengths diverge from
        # the (rank-0-decided) forwarded token count and store_kv_cache fails.

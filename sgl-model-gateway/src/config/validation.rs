...
mod tests {
    ...
    #[test]
    fn test_validate_lmetric_parameters() {
        ...
        let invalid_interval = RouterConfig::new(
            RoutingMode::Regular {
                worker_urls: vec!["http://worker1:8000".to_string()],
            },
            PolicyConfig::LMetric {
        ...
        assert!(ConfigValidator::validate(&invalid_interval).is_err());

        let invalid_tree_size = RouterConfig::new(
            RoutingMode::Regular {
                worker_urls: vec!["http://worker1:8000".to_string()],
            },
            PolicyConfig::LMetric {
        ...
        assert!(ConfigValidator::validate(&invalid_tree_size).is_err());
    }
